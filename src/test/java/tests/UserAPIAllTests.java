...
public class UserAPIAllTests extends BaseTest01 {
	...
	public void testCreateUser(Map<String, Object> testCase) throws Exception {
	    ...
	    try {
	        ...
	        if (expectedStatusCode == 201) {
	            ...
	            //Assert.assertEquals(response.jsonPath().getString("userAddress.zipCode"), user.getUserAddress().getZipCode(), "Mismatch in zipCode");
	            //Assert.assertEquals(response.jsonPath().getString("userAddress.zipCode"), String.valueOf(user.getUserAddress().getZipCode()), "Mismatch in zipCode");
